...
import AdminResponsiveNavLink from '@/Components/AdminResponsiveNavLink.vue';
...
<template>
    <div>
        <div class="min-h-screen bg-gray-100">
                        ...
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link :href="route('dashboard.index')">
                                    <h1 class="text-2lg text-gray-200 hover:text-gray-400 focus:text-gray-500">MV Dashboard</h1>
                                </Link>
                            </div>
                        ...
                        <div v-if="$page.props.auth.admin" class="hidden sm:flex sm:items-center sm:ms-6">
                            ...
                            <div class="ms-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        <DropdownLink :href="route('dashboard.profile.edit')"> Perfil </DropdownLink>
                                        <DropdownLink :href="route('dashboard.logout')" method="post" as="button">Sair</DropdownLink>
                                    </template>
                                </Dropdown>
                            </div>
                        </div>
            ...
            <!-- Page Heading -->
            <header class="bg-gray-100 mt-3" v-if="$slots.header">
